...
interface PersonalRenewalFormProps {
  assignedCsrId: string | null;
  onSuccess: () => void;
  onCancel: () => void;
}

export function PersonalRenewalForm({ assignedCsrId, onSuccess, onCancel }: PersonalRenewalFormProps) {
  ...
  const [form, setForm] = useState({
    ...
    current_premium: '',
    carrier: '',
    policy_type: PERSONAL_POLICY_TYPES[0].value,
    referral: '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const validation = validateRenewalRecord(form, 'personal', false)
    ...
    setLoading(true)
    try {
      const { pipelineId, stageId } = await resolveRenewalPipelineAndStage(supabase, 'personal')
    ...
    <div className="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-6 flex items-center justify-between">
        <button
          onClick={onCancel}
          type="button"
          className="inline-flex items-center gap-2 text-sm font-semibold text-gray-600 hover:text-emerald-600 transition-colors bg-white px-4 py-2 rounded-xl border border-gray-200 shadow-sm"
        >
          <ArrowLeft size={16} />
          Back
        </button>
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-emerald-600 to-teal-700 px-6 py-6 text-white">
          <h1 className="text-2xl font-bold tracking-tight">Manual Renewal Entry (Personal Lines)</h1>
          <p className="text-emerald-100 text-sm mt-1">
            Create a single renewal policy manually using the same validation and pipeline rules as Excel import.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="sm:col-span-1">
                <label className="block text-xs font-bold uppercase tracking-wider text-gray-700 mb-1.5">
                  Account / Client Name <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
                  name="client_name"
                  ...
                  required
                  className="w-full px-3.5 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-sm shadow-sm outline-none transition-all"
                />
              </div>
              ...
              <div className="sm:col-span-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3.5 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-sm shadow-sm outline-none transition-all"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="w-full pl-10 pr-3.5 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-sm shadow-sm outline-none transition-all text-gray-800"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    required
                    className="w-full pl-10 pr-3.5 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-sm shadow-sm outline-none transition-all font-semibold"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={form.carrier}
                    onChange={handleChange}
                    placeholder="e.g. Progressive / Travelers"
                    className="w-full pl-10 pr-3.5 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-sm shadow-sm outline-none transition-all"
                  />
                </div>
              </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={3}
              placeholder="Enter any relevant renewal notes or underwriting instructions..."
              className="w-full p-3.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-sm shadow-sm outline-none transition-all"
            />
          </div>
          ...
          <div className="pt-4 border-t border-gray-200 flex justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm shadow-md hover:shadow-lg transition-all flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <>
