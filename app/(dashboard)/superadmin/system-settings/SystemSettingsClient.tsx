        ...
        <form onSubmit={handleSave} className="space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-xl overflow-hidden">
                <div className="px-6 py-4 bg-gradient-to-r from-[#10B889] to-[#2E5C85] flex items-center gap-4">
                    {fieldIcon(<Building2 size={18} />)}
                    <div>
                        <h2 className="text-xs font-bold text-white uppercase tracking-widest">Company Identity</h2>
                        <p className="text-[10px] text-emerald-50/80 font-medium uppercase tracking-wider mt-0.5">Application brand and sender settings</p>
                    </div>
                </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-xl overflow-hidden">
                <div className="px-6 py-4 bg-gradient-to-r from-[#10B889] to-[#2E5C85] flex items-center gap-4">
                    {fieldIcon(<Clock size={18} />)}
                    <div>
                        <h2 className="text-xs font-bold text-white uppercase tracking-widest">System Defaults</h2>
                        <p className="text-[10px] text-emerald-50/80 font-medium uppercase tracking-wider mt-0.5">Routing and regional configuration</p>
                    </div>
                </div>
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex flex-col gap-1.5">
